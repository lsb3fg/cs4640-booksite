                                ...
                                <div id="bookslides" class="carousel slide" data-bs-ride="carousel">
                                    ...
                                    <div class="carousel-inner justify-content-center">
                                        ...
                                        <div class="carousel-item active" style=" overflow: hidden;">
                                            ...
                                            <img src="<?= $book["imagelink"] ?>" class="float-center w-100 ml-10 mr-10 book-image" alt="picture of book" style="  
                                        ...
                                        <div class="carousel-item" style=" overflow: hidden;">
                                            <img src="<?= $book["imagelink"] ?>" class="float-center w-100 ml-10 mr-10 book-image" alt="an alternative image of a book" style=" 
                                            min-width: 200px; height: 300px;" onerror="this.onerror=null;this.src='https://i.imgur.com/O7Wglxz.png';">
                                        </div>
                                    </div>

                                    <button class="carousel-control-prev" type="button" data-bs-target="#bookslides" data-bs-slide="prev">
                                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                        <span class="visually-hidden">Previous</span>
                                    </button>
                                    <button class="carousel-control-next" type="button" data-bs-target="#bookslides" data-bs-slide="next">
